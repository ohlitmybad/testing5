...
updateChart();
    ...
    const metricsData = [
      ...
      { name: 'Accurate passes to final third', data: positionRankAccuratePassesToFinalThirdWithMinutes },
...
updateChart();
    ...
    const metricsData = [
      ...
      { name: 'Accurate passes to final third', data: leagueRankAccuratePassesToFinalThird },
